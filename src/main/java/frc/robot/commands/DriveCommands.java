...
public class DriveCommands {
  public static Command tankDrive(SimpleDifferentialDrive drivetrain, DoubleSupplier left, DoubleSupplier right) {
  ...
  public static Command arcadeDrive(SimpleDifferentialDrive drivetrain, DoubleSupplier move, DoubleSupplier turn) {
    return drivetrain.runEnd(
